...
void loop(){
  ...
  if(SerialBT.available()){
    ...
    if(cmd=="GO"){
      ...
      SerialBT.print("  FL: "); SerialBT.print(rpm1, 1);
      SerialBT.print("   RL: "); SerialBT.println(rpm3, 1);
      SerialBT.print("  FR: "); SerialBT.print(rpm2, 1);
      ...
      SerialBT.print("  FL: "); SerialBT.print(r_fl, 2);
      SerialBT.print("   RL: "); SerialBT.println(FR_RADIUS, 2);
      SerialBT.print("  FR: "); SerialBT.print(r_rl, 2);
